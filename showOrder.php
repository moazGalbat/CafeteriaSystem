...
{ 
    ...
    if(isset($_POST['username']))
       {     $user_name=$_POST['username'];
            ...
            from orderT ,order_product , product ,user
            where orderT.order_id=order_product.order_id AND 
            product.product_id=order_product.product_id 
            and user.user_id=orderT.user_id  and date between '$from' AND '$to' 
            GROUP by date";
       ...
       else 
       {
            ...
            from orderT ,order_product ,product 
            where orderT.order_id=order_product.order_id AND 
            product.product_id=order_product.product_id 
