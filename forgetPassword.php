...
your account and change your security password as someone may have guessed it.</p>';
      $output .= '<p>Thanks,</p>';
      $output .= '<p>Cafetria Team</p>';
      $body = $output;
      $subject = "Password Recovery - Cafetria";

      $email_to = $email;
      $fromserver = "cafetriaos40@gmail.com";
      $mail = new PHPMailer();
      $mail->IsSMTP();
      $mail->Host = 'smtp.gmail.com'; // Enter your host here
      $mail->SMTPAuth = true;
      $mail->Username = 'cafetriaos40@gmail.com'; // Enter your email here
      $mail->Password = '95327568'; //Enter your password here
      $mail->SMTPSecure = 'tls';
      $mail->Port = 587;
      $mail->IsHTML(true);
      $mail->From =  'cafetriaos40@gmail.com';
      $mail->FromName = "cafetriaos40";
